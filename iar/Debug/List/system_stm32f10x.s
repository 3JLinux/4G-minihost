...
//    Endian       =  little
//    Source file  =  
//        E:\Work\区域管理终端\net_gprs_485_20161220_smsch_ws\CMSIS\system_stm32f10x.c
//    Command line =  
//        E:\Work\区域管理终端\net_gprs_485_20161220_smsch_ws\CMSIS\system_stm32f10x.c
...
//    List file    =  
//        E:\Work\区域管理终端\net_gprs_485_20161220_smsch_ws\iar\Debug\List\system_stm32f10x.s
//
///////////////////////////////////////////////////////////////////////////////
...
??SystemInit_1:
        ...
        CMP      R1,#+1
        BNE.N    ??SystemInit_2
        LDR.N    R1,??DataTable1_3  ;; 0x40022000
        LDR      R2,[R1, #+0]
        ORR      R2,R2,#0x10
        STR      R2,[R1, #+0]
        LDR      R2,[R1, #+0]
...
SystemCoreClockUpdate:
        LDR.N    R0,??DataTable1_5  ;; 0x40021004
        LDR      R1,[R0, #+0]
//  320   
//  321   switch (tmp)
        AND      R1,R1,#0xC
...
//  338       if (pllsource == 0x00)
        LSLS     R2,R2,#+15
        IT       PL 
        LDRPL.N  R2,??DataTable1_6  ;; 0x3d0900
//  339       {
...
//  351         if ((RCC->CFGR & RCC_CFGR_PLLXTPRE) != (uint32_t)RESET)
        ...
        LSLS     R2,R2,#+14
        ITE      MI 
        LDRMI.N  R2,??DataTable1_6  ;; 0x3d0900
        LDRPL.N  R2,??DataTable1_7  ;; 0x7a1200
...
??SystemCoreClockUpdate_0:
        LDR.N    R1,??DataTable1_7  ;; 0x7a1200
//  404       break;
