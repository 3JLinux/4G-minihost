...
//    Endian       =  little
//    Source file  =  
//        E:\Work\区域管理终端\net_gprs_485_20161220_smsch_ws\StdPeriph_Driver\src\stm32f10x_adc.c
//    Command line =  
//        E:\Work\区域管理终端\net_gprs_485_20161220_smsch_ws\StdPeriph_Driver\src\stm32f10x_adc.c
...
//    List file    =  
//        E:\Work\区域管理终端\net_gprs_485_20161220_smsch_ws\iar\Debug\List\stm32f10x_adc.s
//
///////////////////////////////////////////////////////////////////////////////
...
??ADC_DeInit_0:
        LDR.N    R1,??DataTable4_1  ;; 0x40012800
        CMP      R0,R1
        BNE.N    ??ADC_DeInit_2
//  192   {
...
//  200     if (ADCx == ADC3)
??ADC_DeInit_2:
        LDR.N    R1,??DataTable4_2  ;; 0x40013c00
        CMP      R0,R1
        BNE.N    ??ADC_DeInit_3
//  201     {
...
ADC_Init:
        LDR      R2,[R0, #+4]
        LDR.N    R3,??DataTable4_3  ;; 0xfff0feff
        ANDS     R2,R3,R2
        LDR      R3,[R1, #+0]
        ORRS     R2,R3,R2
        LDRB     R3,[R1, #+4]
...
//  255   ADCx->CR2 = tmpreg1;
        LDR.N    R3,??DataTable4_4  ;; 0xfff1f7fd
        LDR      R2,[R0, #+8]
        ANDS     R2,R3,R2
        LDR      R3,[R1, #+12]
        ORRS     R2,R3,R2
...
//  448 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoFunction
          CFI NoCalls ADC_GetResetCalibrationStatus
          CFI NoCalls ADC_GetCalibrationStatus
          CFI NoCalls ADC_GetSoftwareStartConvStatus
          CFI NoCalls ADC_GetSoftwareStartInjectedConvCmdStatus
        THUMB
?Subroutine1:
        AND      R0,R0,#0x1
        BX       LR               ;; return
...
ADC_SoftwareStartConvCmd:
        ...
        LDR      R1,[R0, #+8]
        ITE      NE 
        ORRNE    R1,R1,#0x500000
        BICEQ    R1,R1,#0x500000
//  463   {
...
??ADC_RegularChannelConfig_2:
        CMP      R2,#+13
        BGE.N    ??ADC_RegularChannelConfig_3
        SUBS     R2,R2,#+7
        ADD      R2,R2,R2, LSL #+2
        LDR      R3,[R0, #+48]
        LSLS     R4,R4,R2
...
ADC_SoftwareStartInjectedConvCmd:
        ...
        LDR      R1,[R0, #+8]
        ITE      NE 
        ORRNE    R1,R1,#0x208000
        BICEQ    R1,R1,#0x208000
//  855   {
...
// 1293 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoFunction
          CFI NoCalls ADC_ClearITPendingBit
          CFI NoCalls ADC_ClearFlag
        THUMB
?Subroutine0:
        MVNS     R1,R1
        STR      R1,[R0, #+0]
