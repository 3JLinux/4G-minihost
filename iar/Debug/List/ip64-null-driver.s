...
//    List file    =  
//        E:\Work\区域管理终端\net_gprs_485_20161220_smsch_ws\iar\Debug\List\ip64-null-driver.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   39 /*---------------------------------------------------------------------------*/
        ...
        THUMB
//   40 static int
//   41 output(uint8_t *packet, uint16_t len)
//   42 {
//   43   return 0;
output:
        MOVS     R0,#+0
...
//   45 /*---------------------------------------------------------------------------*/
        ...
        DATA
//   46 const struct ip64_driver ip64_null_driver = {
ip64_null_driver:
        DC32 init, output
