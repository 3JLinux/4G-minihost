...
//    Endian       =  little
//    Source file  =  
//        E:\Work\区域管理终端\net_gprs_485_20161220_smsch_ws\StdPeriph_Driver\src\stm32f10x_tim.c
//    Command line =  
//        E:\Work\区域管理终端\net_gprs_485_20161220_smsch_ws\StdPeriph_Driver\src\stm32f10x_tim.c
...
//    List file    =  
//        E:\Work\区域管理终端\net_gprs_485_20161220_smsch_ws\iar\Debug\List\stm32f10x_tim.s
//
///////////////////////////////////////////////////////////////////////////////
...
??TIM_DeInit_4:
        LDR.W    R1,??DataTable7_2  ;; 0x40000800
        CMP      R0,R1
        BNE.N    ??TIM_DeInit_5
//  143   {
...
??TIM_DeInit_5:
        LDR.W    R1,??DataTable7_3  ;; 0x40000c00
        CMP      R0,R1
        BNE.N    ??TIM_DeInit_6
//  148   {
...
??TIM_DeInit_6:
        LDR.W    R1,??DataTable7_4  ;; 0x40001000
        CMP      R0,R1
        BNE.N    ??TIM_DeInit_7
//  153   {
...
??TIM_DeInit_7:
        LDR.W    R1,??DataTable7_5  ;; 0x40001400
        CMP      R0,R1
        BNE.N    ??TIM_DeInit_8
//  158   {
...
??TIM_DeInit_8:
        LDR.W    R1,??DataTable7_6  ;; 0x40013400
        CMP      R0,R1
        BNE.N    ??TIM_DeInit_9
//  163   {
...
??TIM_DeInit_9:
        LDR.W    R1,??DataTable7_7  ;; 0x40014c00
        CMP      R0,R1
        BNE.N    ??TIM_DeInit_10
//  168   {      
...
??TIM_DeInit_10:
        LDR.W    R1,??DataTable7_8  ;; 0x40015000
        CMP      R0,R1
        BNE.N    ??TIM_DeInit_11
//  173   {      
...
??TIM_DeInit_11:
        LDR.W    R1,??DataTable7_9  ;; 0x40015400
        CMP      R0,R1
        BNE.N    ??TIM_DeInit_12
//  178   {     
...
??TIM_DeInit_12:
        LDR.W    R1,??DataTable7_10  ;; 0x40001800
        CMP      R0,R1
        BNE.N    ??TIM_DeInit_13
//  183   {      
...
??TIM_DeInit_13:
        LDR.W    R1,??DataTable7_11  ;; 0x40001c00
        CMP      R0,R1
        BNE.N    ??TIM_DeInit_14
//  188   {       
...
??TIM_DeInit_14:
        LDR.W    R1,??DataTable7_12  ;; 0x40002000
        CMP      R0,R1
        BNE.N    ??TIM_DeInit_15
//  193   {       
...
??TIM_DeInit_15:
        LDR.W    R1,??DataTable7_13  ;; 0x40014000
        CMP      R0,R1
        BNE.N    ??TIM_DeInit_16
//  198   {
...
??TIM_DeInit_16:
        LDR.W    R1,??DataTable7_14  ;; 0x40014400
        CMP      R0,R1
        BNE.N    ??TIM_DeInit_17
//  203   {
...
//  209     if (TIMx == TIM17)
??TIM_DeInit_17:
        LDR.W    R1,??DataTable7_15  ;; 0x40014800
        CMP      R0,R1
        BNE.N    ??TIM_DeInit_18
//  210     {
...
//  238      (TIMx == TIM4) || (TIMx == TIM5)) 
        CMP      R0,R2
        ITT      NE 
        LDRNE.W  R4,??DataTable7_6  ;; 0x40013400
        CMPNE    R0,R4
        BEQ.N    ??TIM_TimeBaseInit_0
        CMP      R0,#+1073741824
        ITT      NE 
        LDRNE.W  R4,??DataTable7_1  ;; 0x40000400
        CMPNE    R0,R4
        BEQ.N    ??TIM_TimeBaseInit_0
        LDR.W    R4,??DataTable7_2  ;; 0x40000800
        CMP      R0,R4
        ITT      NE 
        LDRNE.W  R4,??DataTable7_3  ;; 0x40000c00
        CMPNE    R0,R4
...
??TIM_TimeBaseInit_1:
        LDR.W    R4,??DataTable7_4  ;; 0x40001000
        CMP      R0,R4
        ITT      NE 
        LDRNE.W  R4,??DataTable7_5  ;; 0x40001400
        CMPNE    R0,R4
...
//  255   TIMx->ARR = TIM_TimeBaseInitStruct->TIM_Period ;
        ...
        STRH     R3,[R0, #+44]
        ITT      NE 
        LDRNE.W  R2,??DataTable7_6  ;; 0x40013400
        CMPNE    R0,R2
//  256  
...
//  260   if ((TIMx == TIM1) || (TIMx == TIM8)|| (TIMx == TIM15)|| (TIMx == TIM16) || (TIMx == TIM17))  
        ...
        LDR.W    R2,??DataTable7_13  ;; 0x40014000
        CMP      R0,R2
        ITTTT    NE 
        LDRNE.W  R2,??DataTable7_14  ;; 0x40014400
        CMPNE    R0,R2
        LDRNE.W  R2,??DataTable7_15  ;; 0x40014800
        CMPNE    R0,R2
...
//  314      (TIMx == TIM16)|| (TIMx == TIM17))
        ...
        CMP      R0,R5
        ITT      NE 
        LDRNE.W  R5,??DataTable7_6  ;; 0x40013400
        CMPNE    R0,R5
        BEQ.N    ??TIM_OC1Init_0
        LDR.W    R5,??DataTable7_13  ;; 0x40014000
        CMP      R0,R5
        ITTTT    NE 
        LDRNE.W  R5,??DataTable7_14  ;; 0x40014400
        CMPNE    R0,R5
        LDRNE.W  R5,??DataTable7_15  ;; 0x40014800
        CMPNE    R0,R5
        BNE.N    ??TIM_OC1Init_1
//  315   {
...
//  513 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoFunction
          CFI NoCalls TIM_OC3Init
          CFI NoCalls TIM_OC2Init
          CFI NoCalls TIM_OC4Init
          CFI CFA R13+12
          CFI R4 Frame(CFA, -12)
          CFI R5 Frame(CFA, -8)
          CFI R6 Frame(CFA, -4)
...
//  610                TIM_ICInitStruct->TIM_ICFilter);
        ...
        CMP      R0,R5
        ITT      NE 
        LDRNE.W  R3,??DataTable7_6  ;; 0x40013400
        CMPNE    R0,R3
        BEQ.N    ??TIM_ICInit_1
        CMP      R0,#+1073741824
        ITT      NE 
        LDRNE.W  R3,??DataTable7_1  ;; 0x40000400
        CMPNE    R0,R3
        BEQ.N    ??TIM_ICInit_1
        LDR.W    R3,??DataTable7_2  ;; 0x40000800
        CMP      R0,R3
        ITTT     NE 
        LDRNE.W  R3,??DataTable7_3  ;; 0x40000c00
        CMPNE    R0,R3
        MOVWNE   R3,#+65525
        BNE.N    ??TIM_ICInit_2
??TIM_ICInit_1:
...
//  846 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoFunction
          CFI NoCalls TIM_BDTRConfig
          CFI NoCalls TIM_CtrlPWMOutputs
        THUMB
?Subroutine13:
        STRH     R1,[R0, #+68]
        BX       LR               ;; return
...
// 1044   if (TIM_TIxExternalCLKSource == TIM_TIxExternalCLK1Source_TI2)
        CMP      R1,#+96
        LDRH     R5,[R0, #+32]
        LDR.W    R4,??DataTable7  ;; 0x40012c00
...
// 1046     TI2_Config(TIMx, TIM_ICPolarity, TIM_ICSelection_DirectTI, ICFilter);
        ...
        ANDS     R4,R4,R5
        ORRS     R2,R2,R4
        B.N      ??TIM_TIxExternalClockConfig_2
...
??TIM_TIxExternalClockConfig_2:
        ORR      R2,R2,#0x10
        B.N      ??TIM_TIxExternalClockConfig_3
// 1047   }
// 1048   else
// 1049   {
...
??TIM_TIxExternalClockConfig_0:
        ...
        CMPNE    R0,R4
        ORR      R3,R3,#0x1
        BEQ.N    ??TIM_TIxExternalClockConfig_4
        CMP      R0,#+1073741824
        ITT      NE 
        LDRNE.W  R4,??DataTable7_1  ;; 0x40000400
        CMPNE    R0,R4
        ...
        CMPNE    R0,R4
        MOVWNE   R4,#+65525
        BNE.N    ??TIM_TIxExternalClockConfig_5
...
// 1522 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoFunction
          CFI NoCalls TIM_SetIC1Prescaler
          CFI NoCalls TIM_ClearOC1Ref
          CFI NoCalls TIM_OC1FastConfig
          CFI NoCalls TIM_OC1PreloadConfig
          CFI NoCalls TIM_ForcedOC1Config
        THUMB
?Subroutine7:
        ANDS     R2,R3,R2
??Subroutine7_0:
...
// 1547 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoFunction
          CFI NoCalls TIM_SetIC2Prescaler
          CFI NoCalls TIM_OC2FastConfig
          CFI NoCalls TIM_OC2PreloadConfig
          CFI NoCalls TIM_ClearOC2Ref
          CFI NoCalls TIM_ForcedOC2Config
        THUMB
?Subroutine3:
        ANDS     R2,R3,R2
??Subroutine3_0:
...
// 1571 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoFunction
          CFI NoCalls TIM_SetIC3Prescaler
          CFI NoCalls TIM_OC3FastConfig
          CFI NoCalls TIM_OC3PreloadConfig
          CFI NoCalls TIM_ClearOC3Ref
          CFI NoCalls TIM_ForcedOC3Config
        THUMB
?Subroutine8:
        ANDS     R2,R3,R2
??Subroutine8_0:
...
// 1595 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoFunction
          CFI NoCalls TIM_SetIC4Prescaler
          CFI NoCalls TIM_OC4FastConfig
          CFI NoCalls TIM_OC4PreloadConfig
          CFI NoCalls TIM_ClearOC4Ref
          CFI NoCalls TIM_ForcedOC4Config
        THUMB
?Subroutine4:
        ANDS     R2,R3,R2
??Subroutine4_0:
...
// 1841 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoFunction
          CFI NoCalls TIM_OC1NPolarityConfig
          CFI NoCalls TIM_OC1PolarityConfig
        THUMB
?Subroutine9:
        ANDS     R2,R3,R2
        ORRS     R1,R1,R2
...
// 1888 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoFunction
          CFI NoCalls TIM_OC2NPolarityConfig
          CFI NoCalls TIM_OC2PolarityConfig
        THUMB
?Subroutine5:
        ANDS     R2,R3,R2
        ORR      R1,R2,R1, LSL #+4
...
// 1936 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoFunction
          CFI NoCalls TIM_OC3PolarityConfig
          CFI NoCalls TIM_OC3NPolarityConfig
        THUMB
?Subroutine6:
        ANDS     R2,R3,R2
        ORR      R1,R2,R1, LSL #+8
...
// 2020 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoFunction
          CFI NoCalls TIM_CCxCmd
          CFI NoCalls TIM_CCxNCmd
        THUMB
?Subroutine0:
        LSL      R12,R12,R1
        BIC      R3,R3,R12
...
// 2256 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoFunction
          CFI NoCalls TIM_SelectMasterSlaveMode
          CFI NoCalls TIM_SelectSlaveMode
          CFI NoCalls TIM_SelectInputTrigger
        THUMB
?Subroutine2:
        ANDS     R2,R3,R2
        STRH     R2,[R0, #+8]
...
// 2450 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoFunction
          CFI NoCalls TIM_SetClockDivision
          CFI NoCalls TIM_SelectOnePulseMode
          CFI NoCalls TIM_CounterModeConfig
        THUMB
?Subroutine1:
        ANDS     R2,R3,R2
        STRH     R2,[R0, #+0]
...
// 2682   TIMx->SR = (uint16_t)~TIM_IT;
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoFunction
          CFI NoCalls TIM_ClearFlag
          CFI NoCalls TIM_ClearITPendingBit
        THUMB
?Subroutine12:
        MVNS     R1,R1
        STRH     R1,[R0, #+16]
...
// 2714      (TIMx == TIM4) ||(TIMx == TIM5))
        LDR.N    R3,??DataTable7  ;; 0x40012c00
        CMP      R0,R3
        ITT      NE 
        LDRNE.N  R3,??DataTable7_6  ;; 0x40013400
        CMPNE    R0,R3
        BEQ.N    ??TI1_Config_0
        CMP      R0,#+1073741824
        ITT      NE 
        LDRNE.N  R3,??DataTable7_1  ;; 0x40000400
        CMPNE    R0,R3
        BEQ.N    ??TI1_Config_0
        LDR.N    R3,??DataTable7_2  ;; 0x40000800
        CMP      R0,R3
        ITT      NE 
        LDRNE.N  R3,??DataTable7_3  ;; 0x40000c00
        CMPNE    R0,R3
        BNE.N    ??TI1_Config_1
// 2715   {
...
// 2763      (TIMx == TIM4) ||(TIMx == TIM5))
        LDR.N    R3,??TI2_Config_0  ;; 0x40012c00
        CMP      R0,R3
        ITT      NE 
        LDRNE.N  R3,??TI2_Config_0+0x4  ;; 0x40013400
        CMPNE    R0,R3
        BEQ.N    ??TI2_Config_1
        CMP      R0,#+1073741824
        ITT      NE 
        LDRNE.N  R3,??TI2_Config_0+0x8  ;; 0x40000400
        CMPNE    R0,R3
        BEQ.N    ??TI2_Config_1
        LDR.N    R3,??TI2_Config_0+0xC  ;; 0x40000800
        CMP      R0,R3
        ITT      NE 
        LDRNE.N  R3,??TI2_Config_0+0x10  ;; 0x40000c00
        CMPNE    R0,R3
        BNE.N    ??TI2_Config_2
// 2764   {
...
// 2779 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoFunction
          CFI NoCalls TI2_Config
          CFI NoCalls TIM_EncoderInterfaceConfig
          CFI CFA R13+16
          CFI R4 Frame(CFA, -16)
          CFI R5 Frame(CFA, -12)
          CFI R6 Frame(CFA, -8)
