...
//   45   NETSTACK_RADIO.init();
        LDR.N    R0,??netstack_init_0
        LDR      R0,[R0, #+0]
          CFI FunCall
        BLX      R0
//   46   NETSTACK_RDC.init();
        LDR.N    R0,??netstack_init_0+0x4
        LDR      R0,[R0, #+4]
          CFI FunCall
        BLX      R0
//   47   NETSTACK_MAC.init();
        LDR.N    R0,??netstack_init_0+0x8
        LDR      R0,[R0, #+4]
          CFI FunCall
        BLX      R0
//   48   NETSTACK_NETWORK.init();
        LDR.N    R0,??netstack_init_0+0xC
        LDR      R0,[R0, #+4]
        POP      {R1,LR}
          CFI R14 SameValue
          CFI CFA R13+0
