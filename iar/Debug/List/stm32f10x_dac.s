...
//    Endian       =  little
//    Source file  =  
//        E:\Work\区域管理终端\net_gprs_485_20161220_smsch_ws\StdPeriph_Driver\src\stm32f10x_dac.c
//    Command line =  
//        E:\Work\区域管理终端\net_gprs_485_20161220_smsch_ws\StdPeriph_Driver\src\stm32f10x_dac.c
...
//    List file    =  
//        E:\Work\区域管理终端\net_gprs_485_20161220_smsch_ws\iar\Debug\List\stm32f10x_dac.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  127   tmpreg1 = DAC->CR;
        LDR.N    R2,??DataTable8  ;; 0x40007400
        LDR      R3,[R2, #+0]
...
DAC_SoftwareTriggerCmd:
        ...
        LSRS     R0,R0,#+4
        LSL      R0,R2,R0
        LDR.N    R2,??DataTable8_1  ;; 0x40007404
        CMP      R1,#+0
        LDR      R1,[R2, #+0]
        ITE      NE 
        ORRNE    R0,R0,R1
...
DAC_DualSoftwareTriggerCmd:
        LDR.N    R1,??DataTable8_1  ;; 0x40007404
        CMP      R0,#+0
        LDR      R0,[R1, #+0]
        ITEE     NE 
        ORRNE    R0,R0,#0x3
...
DAC_WaveGenerationCmd:
        LSL      R0,R1,R0
        LDR.N    R1,??DataTable8  ;; 0x40007400
        CMP      R2,#+0
        LDR      R2,[R1, #+0]
        ITE      NE 
        ORRNE    R0,R0,R2
...
//  380 }
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoFunction
          CFI NoCalls DAC_SetChannel1Data
          CFI NoCalls DAC_SetChannel2Data
          CFI CFA R13+4
        THUMB
?Subroutine0:
        LDR.N    R2,??DataTable8  ;; 0x40007400
...
//  419   *(__IO uint32_t *)tmp = data;
        LDR.N    R2,??DataTable8_2  ;; 0x40007420
        STR      R1,[R2, R0]
//  420 }
        BX       LR               ;; return
